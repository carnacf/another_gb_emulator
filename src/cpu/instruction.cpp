...
namespace cpu
{
    ...
    void Instructions::fillInstructionSet()
    {
        ...
        m_instructionSet[0x80] = &Instructions::add_r<Registers::B>;
        m_instructionSet[0x81] = &Instructions::add_r<Registers::C>;
        m_instructionSet[0x82] = &Instructions::add_r<Registers::D>;
        m_instructionSet[0x83] = &Instructions::add_r<Registers::E>;
        m_instructionSet[0x84] = &Instructions::add_r<Registers::H>;
        m_instructionSet[0x85] = &Instructions::add_r<Registers::L>;
        m_instructionSet[0x86] = &Instructions::add_HL;
        m_instructionSet[0x87] = &Instructions::add_r<Registers::A>;
        m_instructionSet[0x88] = &Instructions::adc_r<Registers::B>;
        m_instructionSet[0x89] = &Instructions::adc_r<Registers::C>;
        m_instructionSet[0x8A] = &Instructions::adc_r<Registers::D>;
    ...
    void Instructions::fillInstructionSetDisassembly()
    {
        ...
        m_instructionSetDisassembly[0x80] = &Instructions::add_r_dis<Registers::B>;
        m_instructionSetDisassembly[0x81] = &Instructions::add_r_dis<Registers::C>;
        m_instructionSetDisassembly[0x82] = &Instructions::add_r_dis<Registers::D>;
        m_instructionSetDisassembly[0x83] = &Instructions::add_r_dis<Registers::E>;
        m_instructionSetDisassembly[0x84] = &Instructions::add_r_dis<Registers::H>;
        m_instructionSetDisassembly[0x85] = &Instructions::add_r_dis<Registers::L>;
        m_instructionSetDisassembly[0x86] = &Instructions::add_HL_dis;
        m_instructionSetDisassembly[0x87] = &Instructions::add_r_dis<Registers::A>;
        m_instructionSetDisassembly[0x88] = &Instructions::adc_r_dis<Registers::B>;
        m_instructionSetDisassembly[0x89] = &Instructions::adc_r_dis<Registers::C>;
        m_instructionSetDisassembly[0x8A] = &Instructions::adc_r_dis<Registers::D>;
